        ...
        <div class='left edge-radius bg-change bri-ness'>
            ...
            <div class='nav-box'>
                <div class='home nav-items'>
                    ...
                    <p class='para-1 font-white'><a class='text-deco-none font-white z' id='z' href='index.php'>Home</a>
                    </p>
                </div>
            ...
            <div class='light-mode font-white z'>
                ...
                <div class='day-night-light'><img id='d-n-light' src='day-mode.png' alt='img'></div>
            </div>
        </div>
        <div class='right bg-change edge-radius'>
            ...
            echo " <form action='profile.php' method='get'>
                    ...
                    <div class='inp-cont'>
                        ...
                        <input type='text'
                            required value='isse$row[name]' name='name'></div>
                        <div class='inp-diamension'>
